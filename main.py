...
points = [(-77.03992009162903, 38.91572572043545)]

# Creates a mapping from street edge id to a list of coordinate tuples
# e.g. ('edge_id', [(5,6),(7,8)])
...
# The same line coords in a format that doesn't use tuples
line_coords_as_list = []
for coord in line_coords:
    line_coords_as_list.append(list(coord))

# Turn the line coords into a shapley line
shapley_line = LineString(ast.literal_eval(str(line_coords_as_list)))

# Print the line as geojson
print(geojson.LineString(line_coords))

# TODO: Compute distance from point to the ends of the line
